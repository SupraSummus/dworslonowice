# Koncepcja: retencyjny ogród wodny z głębią do zanurzenia

Ciąg dalszy [rozpoznania](woda.md).
...
Nie klasyczny staw kąpielowy (rygor czystości wody gryzie się z rybami),
nie basen (drogi, techniczny, bez życia biologicznego).

## Dlaczego to się dobrze składa

Te potrzeby nie konkurują ze sobą — one się wzajemnie wzmacniają:
...
a prawnie całość to „oczka wodne", bez tematu zgody wodnoprawnej.
...
- Woda gruntowa głęboko (>5 m) → niecki jej nie sięgną,
  więc temat zgody wodnoprawnej odpada — patrz [rozpoznanie](woda.md).
...
## Ustalone / do ustalenia

Ustalone:

- Teren: trzy działki po ~1000 m² (razem teren MW.1 w MPZP) —
  dwór na frontowej (bez miejsca na staw),
  system wodny na dwóch tylnych (dostępnych tylko przez frontową);
  granice działek nie zwiększają limitu 50 m², patrz formalności.
- Zlewnia: tylna połać dachu dworu (~100 m²)
  + dach obiektu gospodarczego 9×5 m (~50 m²) = ~150 m², podpinane od razu;
  bilans domyka się z zapasem.
- Woda gruntowa głęboko (>5 m, działka na wzniesieniu) → budowa na folii EPDM,
  suchy wykop, bez zgody wodnoprawnej.
- Układ dwudzielny: część górna (sadzawka murowana + staw) na stałym lustrze,
  rezerwuar dolny przejmuje wahania i zapas.
- Cała konstrukcja pasywnie mrozoodporna — zero obowiązkowej obsługi sezonowej.
- Rozmieszczenie wzdłuż osi od dworu: sadzawka → staw górny → rezerwuar → strefa bagienna.
- MPZP sprawdzony ([dokument w repo](dokumenty/mpzp-slonowice-2022.pdf)):
  plan wprost dopuszcza retencję i gospodarcze użycie deszczówki,
  strefa „B" premiuje kamień/cegłę/drewno — szczegóły w formalnościach.
